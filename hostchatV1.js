...
// الأصوات عند النقر
$('.register, .login, .guest').on('click', function() {
...
const interval = setInterval(() => {
  ...
  if(countdown <= 0){
    ...
    $('.countdown-wrapper').fadeOut(500);
    console.log("تم تفعيل الشات الآن!");
  }
},1000);

// رسائل متغيرة
const messages = [
  "🎉 استمتعوا بأجمل اللحظات!",
  "❤️ دردشة صوتية ممتعة!",
  "🌹 مسابقات وفعاليات رائعة!"
];
let msgIndex = 0;
setInterval(() => {
  $('.info-text span').fadeOut(400, function(){
